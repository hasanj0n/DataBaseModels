...
CREATE TABLE Employees (
	...
	(
		ReportsTo
	) REFERENCES warehouse.Employees (
		EmployeeID
	)
);

 CREATE  INDEX LastName ON warehouse.Employees(LastName);

 CREATE  INDEX PostalCode ON warehouse.Employees(PostalCode);
...
CREATE TABLE Categories (
 ...
 CREATE  INDEX CategoryName ON warehouse.Categories(CategoryName);
...
CREATE TABLE Customers (
 ...
 CREATE  INDEX City ON warehouse.Customers(City);

 CREATE  INDEX CompanyName ON warehouse.Customers(CompanyName);

 CREATE  INDEX PostalCode ON warehouse.Customers(PostalCode);

 CREATE  INDEX Region ON warehouse.Customers(Region);
...
CREATE TABLE Suppliers (
 ...
 CREATE  INDEX CompanyName ON warehouse.Suppliers(CompanyName);

 CREATE  INDEX PostalCode ON warehouse.Suppliers(PostalCode);
...
CREATE TABLE Orders (
	...
	ShipVia int NULL ,
	Freight decimal(9,2) NULL DEFAULT 0,
	...
	(
		CustomerID
	) REFERENCES warehouse.Customers (
		CustomerID
	),
	...
	(
		ShipVia
	) REFERENCES warehouse.Shippers (
		ShipperID
	)
);

 CREATE  INDEX CustomerID ON warehouse.Orders(CustomerID);

 CREATE  INDEX CustomersOrders1 ON warehouse.Orders(OrderID);

 CREATE  INDEX EmployeeID ON warehouse.Orders(EmployeeID);

  CREATE  INDEX OrderDate ON warehouse.Orders(OrderDate);

 CREATE  INDEX ShippedDate ON warehouse.Orders(ShippedDate);

 CREATE  INDEX ShippersOrders ON warehouse.Orders(ShipVia);

 CREATE  INDEX ShipPostalCode ON warehouse.Orders(ShipPostalCode);
...
CREATE TABLE Products (
	...
	UnitPrice decimal(9,2) NULL DEFAULT 0,
	...
	(
		CategoryID
	) REFERENCES warehouse.Categories (
		CategoryID
	),
	CONSTRAINT FK_Products_Suppliers FOREIGN KEY 
	(
		SupplierID
	) REFERENCES warehouse.Suppliers (
		SupplierID
	)
	
);

 CREATE  INDEX CategoriesProducts1 ON warehouse.Products(ProductID);

 CREATE  INDEX CategoryID ON warehouse.Products(CategoryID);

 CREATE  INDEX ProductName ON warehouse.Products(ProductName);

 CREATE  INDEX SupplierID ON warehouse.Products(SupplierID);
...
CREATE TABLE Order_Details (
	...
	(
		ProductID
	) REFERENCES warehouse.Products (
		ProductID
	)
	
);

 CREATE  INDEX OrderID ON warehouse.Order_Details(OrderID);



 CREATE  INDEX ProductID ON warehouse.Order_Details(ProductID);
...
INSERT Customers VALUES('ANATR','Ana Trujillo Emparedados y helados','Ana Trujillo','Owner','Avda. de la Constituci? 2222','M?ico D.F.',NULL,'05021','Mexico','(5) 555-4729','(5) 555-3745');
INSERT Customers VALUES('ANTON','Antonio Moreno Taquer?','Antonio Moreno','Owner','Mataderos  2312','M?ico D.F.',NULL,'05023','Mexico','(5) 555-3932',NULL);
...
INSERT Customers VALUES('BERGS','Berglunds snabbk?','Christina Berglund','Order Administrator','Berguvsv?en  8','Lule?',NULL,'S-958 22','Sweden','0921-12 34 65','0921-12 34 67');
...
INSERT Customers VALUES('BLONP','Blondesddsl p?e et fils','Fr??ique Citeaux','Marketing Manager','24, place Kl?er','Strasbourg',NULL,'67000','France','88.60.15.31','88.60.15.32');
INSERT Customers VALUES('BOLID','B?ido Comidas preparadas','Mart? Sommer','Owner','C/ Araquil, 67','Madrid',NULL,'28023','Spain','(91) 555 22 82','(91) 555 91 99');
...
INSERT Customers VALUES('CENTC','Centro comercial Moctezuma','Francisco Chang','Marketing Manager','Sierras de Granada 9993','M?ico D.F.',NULL,'05022','Mexico','(5) 555-3392','(5) 555-7293');
INSERT Customers VALUES('CHOPS','Chop-suey Chinese','Yang Wang','Owner','Hauptstr. 29','Bern',NULL,'3012','Switzerland','0452-076545',NULL);
INSERT Customers VALUES('COMMI','Com?cio Mineiro','Pedro Afonso','Sales Associate','Av. dos Lus?das, 23','Sao Paulo','SP','05432-043','Brazil','(11) 555-7647',NULL);
...
INSERT Customers VALUES('FAMIA','Familia Arquibaldo','Aria Cruz','Marketing Assistant','Rua Or?, 92','Sao Paulo','SP','05442-030','Brazil','(11) 555-9857',NULL);
INSERT Customers VALUES('FISSA','FISSA Fabrica Inter. Salchichas S.A.','DieRoel','Accounting Manager','C/ Moralzarzal, 86','Madrid',NULL,'28034','Spain','(91) 555 94 44','(91) 555 55 93');
INSERT Customers VALUES('FOLIG','Folies urmandes','Martine Ranc?' ,'Assistant Sales Agent', '184, chauss? de Tournai','Lille',NULL,'59000','France','20.16.10.16','20.16.10.17');
INSERT Customers VALUES('FOLKO','Folk och f?HB','Maria Larsson','Owner','Åkergatan 24','Br?ke',NULL,'S-844 67','Sweden','0695-34 67 21',NULL);
INSERT Customers VALUES('FRANK','Frankenversand','Peter Franken','Marketing Manager','Berliner Platz 43','M?chen',NULL,'80805','Germany','089-0877310','089-0877451');
...
INSERT Customers VALUES('GALED','Galer? del gastr?omo','Eduardo Saavedra','Marketing Manager','Rambla de Catalu?, 23','Barcelona',NULL,'08022','Spain','(93) 203 4560','(93) 203 4561');
INSERT Customers VALUES('DOS','dos Cocina T?ica','Jos?Pedro Freyre','Sales Manager','C/ Romero, 33','Sevilla',NULL,'41101','Spain','(95) 555 82 82',NULL);

INSERT Customers VALUES('URL','urmet Lanchonetes','Andr?Fonseca','Sales Associate','Av. Brasil, 442','Campinas','SP','04876-786','Brazil','(11) 555-9482',NULL);
...
INSERT Customers VALUES('HANAR','Hanari Carnes','Mario Pontes','Accounting Manager','Rua do Pa?, 67','Rio de Janeiro','RJ','05454-876','Brazil','(21) 555-0091','(21) 555-8765');
INSERT Customers VALUES('HILAA','HILARION-Abastos','Carlos Hern?dez','Sales Representative','Carrera 22 con Ave. Carlos Soublette #8-35','San Crist?al','T?hira','5022','Venezuela','(5) 555-1340','(5) 555-1948');
...
INSERT Customers VALUES('KOENE','K?iglich Essen','Philip Cramer','Sales Associate','Maubelstr. 90','Brandenburg',NULL,'14776','Germany','0555-09876',NULL);
...
INSERT Customers VALUES('LILAS','LILA-Supermercado','Carlos nz?ez','Accounting Manager','Carrera 52 con Ave. Bol?ar #65-98 Llano Lar','Barquisimeto','Lara','3508','Venezuela','(9) 331-6954','(9) 331-7256');
...
INSERT Customers VALUES('MEREP','M?e Paillarde','Jean Fresni?e','Marketing Assistant','43 rue St. Laurent','Montr?l','Qu?ec','H1J 1C3','Canada','(514) 555-8054','(514) 555-8055');
...
INSERT Customers VALUES('OCEAN','Oc?no Atl?tico Ltda.','Yvonne Moncada','Sales Agent','Ing. Gustavo Moncada 8585 Piso 20-A','Buenos Aires',NULL,'1010','Argentina','(1) 135-5333','(1) 135-5535');
...
INSERT Customers VALUES('OTTIK','Ottilies K?eladen','Henriette Pfalzheim','Owner','Mehrheimerstr. 369','K?n',NULL,'50739','Germany','0221-0644327','0221-0765721');
INSERT Customers VALUES('PARIS','Paris sp?ialit?','Marie Bertrand','Owner','265, boulevard Charonne','Paris',NULL,'75012','France','(1) 42.34.22.66','(1) 42.34.22.77');
INSERT Customers VALUES('PERIC','Pericles Comidas cl?icas','Guillermo Fern?dez','Sales Representative','Calle Dr. Jorge Cash 321','M?ico D.F.',NULL,'05033','Mexico','(5) 552-3745','(5) 545-3745');
...
INSERT Customers VALUES('PRINI','Princesa Isabel Vinhos','Isabel de Castro','Sales Representative','Estrada da sa?e n. 58','Lisboa',NULL,'1756','Portugal','(1) 356-5634',NULL);

INSERT Customers VALUES('QUEDE','Que Del?ia','Bernardo Batista','Accounting Manager','Rua da Panificadora, 12','Rio de Janeiro','RJ','02389-673','Brazil','(21) 555-4252','(21) 555-4545');
INSERT Customers VALUES('QUEEN','Queen Cozinha','L?ia Carvalho','Marketing Assistant','Alameda dos Can?ios, 891','Sao Paulo','SP','05487-020','Brazil','(11) 555-1189',NULL);
INSERT Customers VALUES('QUICK','QUICK-Stop','Horst Kloss','Accounting Manager','Taucherstra? 10','Cunewalde',NULL,'01307','Germany','0372-035188',NULL);
INSERT Customers VALUES('RANCH','Rancho grande','Sergio Guti?rez','Sales Representative','Av. del Libertador 900','Buenos Aires',NULL,'1010','Argentina','(1) 123-5555','(1) 123-5556');
...
INSERT Customers VALUES('RICSU','Richter Supermarkt','Michael Holz','Sales Manager','Grenzacherweg 237','Gen?e',NULL,'1203','Switzerland','0897-034214',NULL);
INSERT Customers VALUES('ROMEY','Romero y tomillo','Alejandra Camino','Accounting Manager','Gran V?, 1','Madrid',NULL,'28001','Spain','(91) 745 6200','(91) 745 6210');
INSERT Customers VALUES('SANTG','Sant?urmet','Jonas Bergulfsen','Owner','Erling Skakkes gate 78','Stavern',NULL,'4110','Norway','07-98 92 35','07-98 92 47');
...
INSERT Customers VALUES('SIMOB','Simons bistro','Jytte Petersen','Owner','Vinb?tet 34','Kobenhavn',NULL,'1734','Denmark','31 12 34 56','31 13 35 57');
INSERT Customers VALUES('SPECD','Sp?ialit? du monde','Dominique Perrier','Marketing Manager','25, rue Lauriston','Paris',NULL,'75016','France','(1) 47.55.60.10','(1) 47.55.60.20');
...
INSERT Customers VALUES('SUPRD','Supr?es d?ices','Pascale Cartrain','Accounting Manager','Boulevard Tirou, 255','Charleroi',NULL,'B-6000','Belgium','(071) 23 67 22 20','(071) 23 67 22 21');
...
INSERT Customers VALUES('TOMSP','Toms Spezialit?en','Karin Josephs','Marketing Manager','Luisenstr. 48','M?ster',NULL,'44087','Germany','0251-031259','0251-035695');
INSERT Customers VALUES('TORTU','Tortuga Restaurante','Miguel Angel Paolino','Owner','Avda. Azteca 123','M?ico D.F.',NULL,'05033','Mexico','(5) 555-2933',NULL);

INSERT Customers VALUES('TRADH','Tradição Hipermercados','Anabela Domingues','Sales Representative','Av. In? de Castro, 414','Sao Paulo','SP','05634-030','Brazil','(11) 555-2167','(11) 555-2168');
...
INSERT Customers VALUES('WANDK','Die Wandernde Kuh','Rita M?ler','Sales Representative','Adenauerallee 900','Stuttgart',NULL,'70563','Germany','0711-020361','0711-035428');
...
VALUES (10249,N'TOMSP',6,'7/5/1996','8/16/1996','7/10/1996',1,11.61,
	N'Toms Spezialit?en',N'Luisenstr. 48',N'M?ster',
...
VALUES (10250,N'HANAR',4,'7/8/1996','8/5/1996','7/12/1996',2,65.83,
	N'Hanari Carnes',N'Rua do Pa?, 67',N'Rio de Janeiro',
...
VALUES (10252,N'SUPRD',4,'7/9/1996','8/6/1996','7/11/1996',2,51.30,
	N'Supr?es d?ices',N'Boulevard Tirou, 255',N'Charleroi',
...
VALUES (10255,N'RICSU',9,'7/12/1996','8/9/1996','7/15/1996',3,148.33,
	N'Richter Supermarkt',N'Starenweg 5',N'Gen?e',
...
VALUES (10257,N'HILAA',4,'7/16/1996','8/13/1996','7/22/1996',3,81.91,
	N'HILARION-Abastos',N'Carrera 22 con Ave. Carlos Soublette #8-35',N'San Crist?al',
	N'T?hira',N'5022',N'Venezuela');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
...
VALUES (10259,N'CENTC',4,'7/18/1996','8/15/1996','7/25/1996',3,3.25,
	N'Centro comercial Moctezuma',N'Sierras de Granada 9993',N'M?ico D.F.',
...
VALUES (10260,N'OTTIK',4,'7/19/1996','8/16/1996','7/29/1996',1,55.09,
	N'Ottilies K?eladen',N'Mehrheimerstr. 369',N'K?n',
...
VALUES (10261,N'QUEDE',4,'7/19/1996','8/16/1996','7/30/1996',2,3.05,
	N'Que Del?ia',N'Rua da Panificadora, 12',N'Rio de Janeiro',
...
VALUES (10264,N'FOLKO',6,'7/24/1996','8/21/1996','8/23/1996',3,3.67,
	N'Folk och f?HB',N'Åkergatan 24',N'Br?ke',
...
VALUES (10265,N'BLONP',2,'7/25/1996','8/22/1996','8/12/1996',1,55.28,
	N'Blondel p?e et fils',N'24, place Kl?er',N'Strasbourg',
...
VALUES (10267,N'FRANK',4,'7/29/1996','8/26/1996','8/6/1996',1,208.58,
	N'Frankenversand',N'Berliner Platz 43',N'M?chen',
...
VALUES (10273,N'QUICK',3,'8/5/1996','9/2/1996','8/12/1996',3,76.07,
	N'QUICK-Stop',N'Taucherstra? 10',N'Cunewalde',
...
VALUES (10276,N'TORTU',8,'8/8/1996','8/22/1996','8/14/1996',3,13.84,
	N'Tortuga Restaurante',N'Avda. Azteca 123',N'M?ico D.F.',
...
VALUES (10278,N'BERGS',8,'8/12/1996','9/9/1996','8/16/1996',2,92.69,
	N'Berglunds snabbk?',N'Berguvsv?en  8',N'Lule?',
...
VALUES (10281,N'ROMEY',4,'8/14/1996','8/28/1996','8/21/1996',1,2.94,
	N'Romero y tomillo',N'Gran V?, 1',N'Madrid',
...
VALUES (10283,N'LILAS',3,'8/16/1996','9/13/1996','8/23/1996',3,84.81,
	N'LILA-Supermercado',N'Carrera 52 con Ave. Bol?ar #65-98 Llano Lar',N'Barquisimeto',
...
VALUES (10290,N'COMMI',8,'8/27/1996','9/24/1996','9/3/1996',1,79.70,
	N'Com?cio Mineiro',N'Av. dos Lus?das, 23',N'Sao Paulo',
...
VALUES (10292,N'TRADH',1,'8/28/1996','9/25/1996','9/2/1996',2,1.35,
	N'Tradi?o Hipermercados',N'Av. In? de Castro, 414',N'Sao Paulo',
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10298,N'HUN',6,'9/5/1996','10/3/1996','9/11/1996',2,168.22,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10303,N'DOS',7,'9/11/1996','10/9/1996','9/18/1996',2,107.83,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
...
VALUES (10308,N'ANATR',7,'9/18/1996','10/16/1996','9/24/1996',3,1.61,
	N'Ana Trujillo Emparedados y helados',N'Avda. de la Constituci? 2222',N'M?ico D.F.',
	NULL,N'05021',N'Mexico');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10309,N'HUN',3,'9/19/1996','10/17/1996','10/23/1996',1,47.30,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
VALUES (10322,N'PERIC',7,'10/4/1996','11/1/1996','10/23/1996',3,0.40,
	N'Pericles Comidas cl?icas',N'Calle Dr. Jorge Cash 321',N'M?ico D.F.',
	NULL,N'05033',N'Mexico');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
...
VALUES (10323,N'KOENE',4,'10/7/1996','11/4/1996','10/14/1996',1,4.88,
	N'K?iglich Essen',N'Maubelstr. 90',N'Brandenburg',
...
VALUES (10326,N'BOLID',4,'10/10/1996','11/7/1996','10/14/1996',2,77.92,
	N'B?ido Comidas preparadas',N'C/ Araquil, 67',N'Madrid',
...
VALUES (10332,N'MEREP',3,'10/17/1996','11/28/1996','10/21/1996',2,52.84,
	N'M?e Paillarde',N'43 rue St. Laurent',N'Montr?l',
	N'Qu?ec',N'H1J 1C3',N'Canada');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10335,N'HUN',7,'10/22/1996','11/19/1996','10/24/1996',2,42.11,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
VALUES (10336,N'PRINI',7,'10/23/1996','11/20/1996','10/25/1996',2,15.51,
	N'Princesa Isabel Vinhos',N'Estrada da sa?e n. 58',N'Lisboa',
...
VALUES (10341,N'SIMOB',7,'10/29/1996','11/26/1996','11/5/1996',3,26.78,
	N'Simons bistro',N'Vinb?tet 34',N'Kobenhavn',
...
VALUES (10347,N'FAMIA',4,'11/6/1996','12/4/1996','11/8/1996',3,3.10,
	N'Familia Arquibaldo',N'Rua Or?, 92',N'Sao Paulo',
...
VALUES (10365,N'ANTON',3,'11/27/1996','12/25/1996','12/2/1996',2,22.00,
	N'Antonio Moreno Taquer?',N'Mataderos  2312',N'M?ico D.F.',
...
VALUES (10366,N'GALED',8,'11/28/1996','1/9/1997','12/30/1996',2,10.14,
	N'Galer? del gastron?o',N'Rambla de Catalu?, 23',N'Barcelona',
	NULL,N'8022',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
...
VALUES (10372,N'QUEEN',5,'12/4/1996','1/1/1997','12/9/1996',2,890.78,
	N'Queen Cozinha',N'Alameda dos Can?ios, 891',N'Sao Paulo',
	N'SP',N'05487-020',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10373,N'HUN',4,'12/5/1996','1/2/1997','12/11/1996',3,124.12,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10380,N'HUN',8,'12/12/1996','1/9/1997','1/16/1997',3,35.03,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
VALUES (10387,N'SANTG',1,'12/18/1996','1/15/1997','12/20/1996',2,93.63,
	N'Sant?urmet',N'Erling Skakkes gate 78',N'Stavern',
...
VALUES (10408,N'FOLIG',8,'1/8/1997','2/5/1997','1/14/1997',1,11.26,
	N'Folies urmandes',N'184, chauss? de Tournai',N'Lille',
...
VALUES (10409,N'OCEAN',3,'1/9/1997','2/6/1997','1/14/1997',1,29.83,
	N'Oc?no Atl?tico Ltda.',N'Ing. Gustavo Moncada 8585 Piso 20-A',N'Buenos Aires',
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10423,N'URL',6,'1/23/1997','2/6/1997','2/24/1997',3,24.50,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10429,N'HUN',3,'1/29/1997','3/12/1997','2/7/1997',2,56.63,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10503,N'HUN',6,'4/11/1997','5/9/1997','4/16/1997',2,16.74,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10516,N'HUN',2,'4/24/1997','5/22/1997','5/1/1997',3,62.78,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10550,N'DOS',7,'5/28/1997','6/25/1997','6/6/1997',3,4.32,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10567,N'HUN',1,'6/12/1997','7/10/1997','6/17/1997',1,33.97,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
VALUES (10574,N'TRAIH',4,'6/19/1997','7/17/1997','6/30/1997',2,37.60,
	N'Trail''s Head urmet Provisioners',N'722 DaVinci Blvd.',N'Kirkland',
	N'WA',N'98034',N'USA');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10629,N'DOS',4,'8/12/1997','9/9/1997','8/20/1997',3,85.46,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10646,N'HUN',9,'8/27/1997','10/8/1997','9/3/1997',3,142.33,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10652,N'URL',4,'9/1/1997','9/29/1997','9/8/1997',2,7.14,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10661,N'HUN',7,'9/9/1997','10/7/1997','9/15/1997',3,17.55,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10685,N'URL',4,'9/29/1997','10/13/1997','10/3/1997',2,33.75,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10687,N'HUN',9,'9/30/1997','10/28/1997','10/30/1997',2,296.43,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10701,N'HUN',6,'10/13/1997','10/27/1997','10/15/1997',3,220.31,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10709,N'URL',1,'10/17/1997','11/14/1997','11/20/1997',3,210.80,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10712,N'HUN',3,'10/21/1997','11/18/1997','10/31/1997',1,89.93,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10734,N'URL',2,'11/7/1997','12/5/1997','11/12/1997',3,1.63,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10736,N'HUN',9,'11/11/1997','12/9/1997','11/21/1997',2,44.10,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
VALUES (10738,N'SPECD',2,'11/12/1997','12/10/1997','11/18/1997',1,2.91,
	N'Sp?ialit? du monde',N'25, rue Lauriston',N'Paris',
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10777,N'URL',7,'12/15/1997','12/29/1997','1/21/1998',2,3.01,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10790,N'URL',6,'12/22/1997','1/19/1998','12/26/1997',1,28.23,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10872,N'DOS',5,'2/5/1998','3/5/1998','2/9/1998',2,175.32,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10874,N'DOS',5,'2/6/1998','3/6/1998','2/11/1998',2,19.58,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10888,N'DOS',1,'2/16/1998','3/16/1998','2/23/1998',2,51.87,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10897,N'HUN',3,'2/19/1998','3/19/1998','2/25/1998',2,603.54,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10911,N'DOS',3,'2/26/1998','3/26/1998','3/5/1998',1,38.19,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10912,N'HUN',2,'2/26/1998','3/26/1998','3/18/1998',2,580.91,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10948,N'DOS',3,'3/13/1998','4/10/1998','3/19/1998',3,23.39,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10959,N'URL',6,'3/18/1998','4/29/1998','3/23/1998',2,4.98,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (10985,N'HUN',2,'3/30/1998','4/27/1998','4/2/1998',1,91.51,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (11009,N'DOS',2,'4/8/1998','5/6/1998','4/10/1998',1,59.11,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (11037,N'DOS',7,'4/21/1998','5/19/1998','4/27/1998',1,3.20,
	N'dos Cocina T?ica',N'C/ Romero, 33',N'Sevilla',
	NULL,N'41101',N'Spain');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (11049,N'URL',3,'4/24/1998','5/22/1998','5/4/1998',1,8.34,
	N'urmet Lanchonetes',N'Av. Brasil, 442',N'Campinas',
	N'SP',N'04876-786',N'Brazil');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
	ShippedDate,ShipVia,Freight,ShipName,ShipAddress,
	ShipCity,ShipRegion,ShipPostalCode,ShipCountry)
VALUES (11063,N'HUN',3,'4/30/1998','5/28/1998','5/6/1998',2,81.73,
	N'Hungry Owl All-Night Grocers',N'8 Johnstown Road',N'Cork',
	N'Co. Cork',NULL,N'Ireland');
INSERT INTO Orders
(OrderID,CustomerID,EmployeeID,OrderDate,RequiredDate,
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(9,'PB Kn?kebr? AB','Lars Peterson','Sales Agent','Kaloadagatan 13','G?eborg',NULL,'S-345 67','Sweden','031-987 65 43','031-987 65 91',NULL);
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(11,'Heli Süßwaren GmbH & Co. KG','Petra Winkler','Sales Manager','Tiergartenstra? 5','Berlin',NULL,'10785','Germany','(010) 9984510',NULL,NULL);
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(12,'Plutzer Lebensmittelgro??kte AG','Martin Bein','International Marketing Mgr.','Bogenallee 51','Frankfurt',NULL,'60439','Germany','(069) 992755',NULL,'Plutzer (on the World Wide Web)#http://www.microsoft.com/accessdev/sampleapps/plutzer.htm#');
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(17,'Svensk Sj??a AB','Michael Bj?n','Sales Representative','Brovallav?en 231','Stockholm',NULL,'S-123 45','Sweden','08-123 45 67',NULL,NULL);
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(18,'Aux joyeux eccl?iastiques','Guyl?e Nodier','Sales Manager','203, Rue des Francs-Bourgeois','Paris',NULL,'75004','France','(1) 03.83.00.68','(1) 03.83.00.62',NULL);
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(20,'Leka Trading','Chandra Leka','Owner','471 Seranon Loop, Suite #402','Singapore',NULL,'0512','Singapore','555-8787',NULL,NULL);
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(25,'Ma Maison','Jean-Guy Lauzon','Marketing Manager','2960 Rue St. Laurent','Montr?l','Qu?ec','H1J 1C3','Canada','(514) 555-9022',NULL,NULL);
...
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(27,'Escarts Nouveaux','Marie Delamare','Sales Manager','22, rue H. Voiron','Montceau',NULL,'71300','France','85.57.00.07',NULL,NULL);
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(28,'Gai p?urage','Eliane Noz','Sales Representative','Bat. B 3, rue des Alpes','Annecy',NULL,'74000','France','38.76.98.06','38.76.98.58',NULL);
INSERT Suppliers(SupplierID,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax,HomePage) VALUES(29,'For?s d''?ables','Chantal ulet','Accounting Manager','148 rue Chasseur','Ste-Hyacinthe','Qu?ec','J2S 7S8','Canada','(514) 555-2955','(514) 555-2921',NULL);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(12,'Queso MancheLa Pastora',5,4,'10 - 500 g pkgs.',38,86,0,0,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(22,'Gustaf''s Kn?kebr?',9,5,'24 - 500 g pkgs.',21,104,0,25,0);
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(23,'Tunnbr?',9,5,'12 - 250 g pkgs.',9,61,0,25,0);
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(24,'Guaran?Fant?tica',10,1,'12 - 355 ml cans',4.5,20,0,0,1);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(26,'Gumb? Gummib?chen',11,3,'100 - 250 g bags',31.23,15,0,0,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(28,'R?sle Sauerkraut',12,7,'25 - 825 g cans',45.6,26,0,0,1);
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(29,'Th?inger Rostbratwurst',12,6,'50 bags x 30 sausgs.',123.79,0,0,0,1);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(38,'C?e de Blaye',18,1,'12 - 75 cl bottles',263.5,17,0,15,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(54,'Tourti?e',25,6,'16 pies',7.45,21,0,10,0);
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(55,'P??chinois',25,6,'24 boxes x 2 pies',24,115,0,20,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(61,'Sirop d''?able',29,2,'24 - 500 ml bottles',28.5,113,0,25,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(64,'Wimmers gute Semmelkn?el',12,5,'20 bags x 4 pieces',33.25,22,80,30,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(73,'R? Kaviar',17,8,'24 - 150 g jars',15,101,0,5,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(75,'Rh?br? Klosterbier',12,1,'24 - 0.5 l bottles',7.75,125,0,25,0);
...
INSERT Products(ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued) VALUES(77,'Original Frankfurter gr?e So?',12,2,'12 boxes',13,32,0,15,0);
...
/* The following adds tables to the final project database */



		
	
CREATE TABLE warehouse.Region 
	( RegionID int NOT NULL ,
	RegionDescription char (50) NOT NULL 
) ;


CREATE TABLE warehouse.Territories 
...
CREATE TABLE warehouse.EmployeeTerritories 
...
Insert Into Territories Values ('60601','Chica',2);
...
--  The following adds constraints to the final project database
...
ALTER TABLE EmployeeTerritories	
	...
	(
		TerritoryID
	) REFERENCES warehouse.Territories (
		TerritoryID
	);
